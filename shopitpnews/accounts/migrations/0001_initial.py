    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('parent_farm', 'مزرعه مرغ مادر'), ('grow_out', 'واحد پرورش'), ('broker', 'واسطه و کارگزار')], max_length=32, verbose_name='نوع فعالیت')),
                ('is_phone_verified', models.BooleanField(default=False, verbose_name='تایید موبایل')),
